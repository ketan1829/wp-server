...
const doc = {
  info: {
    ...
    title: 'wa API Rest',
    description:
      'Welcome to the wa-server API documentation. This API provides a set of endpoints to interact with the wa-server application, allowing you to build integrations and automate interactions with WhatsApp.',
  },
