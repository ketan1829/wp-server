...
const doc = {
  info: {
    version: '2.0.0',
    title: 'WA-Server API Rest',
    description:
      'Welcome to the WA-Server API documentation. This API provides a set of endpoints to interact with the wppconnect-server application, allowing you to build integrations and automate interactions with WhatsApp.',
  },
